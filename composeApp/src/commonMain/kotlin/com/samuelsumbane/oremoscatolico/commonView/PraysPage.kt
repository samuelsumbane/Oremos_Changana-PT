...
@Composable
fun PraysPage(navigator: Navigator) {
...
//    }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { if (!isSearchInputVisible) Text(text = stringResource(Res.string.prays), color = MaterialTheme.colorScheme.tertiary)},
...
//                    }
        ...
        bottomBar = {
            if (isAndroid()) {
//                if (isPortrait) BottomAppBarPrincipal(navigator, "oracoespage")
            }
        }
    ) { paddingVales ->
